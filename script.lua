...
EzLauncher.EzLauncher.Name = "Test"
...
EzLauncher.StatusName.Text = "Test Hub"
...
EzLauncher.StatusName_2.Text = "API"
...
EzLauncher.StatusName_3.Text = "Launcher"
...
local launcherData = game:GetService("HttpService"):JSONDecode(
	(game:HttpGet("https://raw.githubusercontent.com/Banee1/testo/main/themes.lua")));
